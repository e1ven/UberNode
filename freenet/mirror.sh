...
httrack  --mirror --update --mirrorlinks -r2 -%e2 -H3 -C2 --near http://mirrordot.org  -F "Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/412.6 (KHTML, like Gecko) Safari/412.2" +*.gif +*.jpg +*.png +*.js +*.css 
cd /usr/local/freenet/mirror/digg
httrack --mirror --update --mirrorlinks -r2 -%e2 -H3 -C2 --near http://digg.com -F "Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/412.6 (KHTML, like Gecko) Safari/412.2" +*.gif +*.jpg +*.png +*.js +*.css
...
httrack  --mirror --update http://ubernode.org/news
cd /usr/local/freenet/mirror/daringfireball
httrack  --mirror --update --mirrorlinks -r3 -%e2 -H3 -C2 --near http://Daringfireball.net -F "Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/412.6 (KHTML, like Gecko) Safari/412.2" +*.gif +*.jpg +*.png +*.js +*.css
